...
if __name__ == "__main__":
    ...
    with open("ddqn_avg_rewards.csv", "w") as f:
        for reward in avg_rewards:
            f.write(f"{reward}\n")

    with open("ddqn_avg_game_scores.csv", "w") as f:
        for game_score in avg_game_scores:
            f.write(f"{game_score}\n")

    with open("ddqn_avg_steps_per_episode.csv", "w") as f:
        for steps in avg_steps_per_episode:
            f.write(f"{steps}\n")

    with open("ddqn_training_times.csv", "w") as f:
        for time in training_times:
            f.write(f"{time}\n")
    
    # Print average metrics over all episodes
    with open("ddqn_avg_metrics.csv", "w") as f:
        # column headers
